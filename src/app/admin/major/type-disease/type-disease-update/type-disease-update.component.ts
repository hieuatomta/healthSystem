...
@Component({
  ...
  styleUrls: ['./type-disease-update.component.scss'],
  templateUrl: './type-disease-update.component.html',
})
export class TypeDiseaseUpdateComponent implements OnInit {
  lstRole = [];
  listStatus = [
  ...
  constructor(
    ...
    public ref: NbDialogRef<TypeDiseaseUpdateComponent>,
