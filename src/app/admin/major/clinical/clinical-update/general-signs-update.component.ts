...
@Component({
  ...
  styleUrls: ['./general-signs-update.component.scss'],
  templateUrl: './general-signs-update.component.html',
})
export class GeneralSignsUpdateComponent implements OnInit {
  lstRole = [];
  listStatus = [
  ...
  constructor(
    ...
    public ref: NbDialogRef<GeneralSignsUpdateComponent>,
