...
@Component({
  ...
  styleUrls: ['./statistical-update.component.scss'],
  templateUrl: './statistical-update.component.html',
})
export class StatisticalUpdateComponent implements OnInit {
  lstRole = [];
  listStatus = [
  ...
  constructor(
    ...
    public ref: NbDialogRef<StatisticalUpdateComponent>,
