...
import {SizesRoutingModule} from './products-selling-routing.module';
...
@NgModule({
  ...
  declarations: [ProductsSellingComponent, SupplierUpdateComponent],
  providers: [ExcelService],
})
export class ProductsSellingModule {
}
