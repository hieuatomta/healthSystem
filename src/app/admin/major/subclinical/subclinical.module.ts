...
import {SizesRoutingModule} from './subclinical-routing.module';
...
@NgModule({
  ...
  entryComponents: [
    SubclinicalUpdateComponent
  ],
  declarations: [SubclinicalComponent, SubclinicalUpdateComponent, MapPopupComponent],
})
export class SubclinicalModule {
}
