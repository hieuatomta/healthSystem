...
@Component({
  ...
  styleUrls: ['./streatments-update.component.scss'],
  templateUrl: './streatments-update.component.html',
})
export class StreatmentsUpdateComponent implements OnInit {
  lstRole = [];
  listStatus = [
  ...
  constructor(
    ...
    public ref: NbDialogRef<StreatmentsUpdateComponent>,
